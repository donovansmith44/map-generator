...
const PLATE_CANAAN_CONTOUR: &[Waypoint] = &[
    ...
    Waypoint { name: "canaan contour 011", lat: 32.88583, lon: 35.37588 },
    Waypoint { name: "canaan contour 012", lat: 32.74325, lon: 35.29354 },
    Waypoint { name: "canaan contour 013", lat: 32.67815, lon: 35.25287 },
    Waypoint { name: "canaan contour 014", lat: 32.65057, lon: 35.22781 },
    Waypoint { name: "canaan contour 015", lat: 32.64307, lon: 35.21058 },
    Waypoint { name: "canaan contour 016", lat: 32.64901, lon: 35.17208 },
    Waypoint { name: "canaan contour 017", lat: 32.68983, lon: 35.11647 },
    Waypoint { name: "canaan contour 018", lat: 32.70301, lon: 35.10931 },
    Waypoint { name: "canaan contour 019", lat: 32.74095, lon: 35.10339 },
    Waypoint { name: "canaan contour 020", lat: 32.76694, lon: 35.07347 },
    Waypoint { name: "canaan contour 021", lat: 32.78980, lon: 35.07170 },
    Waypoint { name: "canaan contour 022", lat: 32.80245, lon: 35.05785 },
    Waypoint { name: "canaan contour 023", lat: 32.80832, lon: 35.05797 },
    Waypoint { name: "canaan contour 024", lat: 32.82231, lon: 35.07681 },
    Waypoint { name: "canaan contour 025", lat: 32.83104, lon: 35.06362 },
    Waypoint { name: "canaan contour 026", lat: 32.84626, lon: 35.05205 },
    Waypoint { name: "canaan contour 027", lat: 32.86847, lon: 35.01537 },
    Waypoint { name: "canaan contour 028", lat: 32.87471, lon: 34.99544 },
    Waypoint { name: "canaan contour 029", lat: 32.86811, lon: 34.96486 },
    Waypoint { name: "canaan contour 030", lat: 32.85219, lon: 34.94449 },
    Waypoint { name: "canaan contour 031", lat: 32.80218, lon: 34.93309 },
    Waypoint { name: "canaan contour 032", lat: 32.77349, lon: 34.93325 },
    Waypoint { name: "canaan contour 033", lat: 32.73713, lon: 34.92435 },
    Waypoint { name: "canaan contour 034", lat: 32.71072, lon: 34.90674 },
    Waypoint { name: "canaan contour 035", lat: 32.67357, lon: 34.90599 },
    Waypoint { name: "canaan contour 036", lat: 32.65480, lon: 34.89818 },
    Waypoint { name: "canaan contour 037", lat: 32.60600, lon: 34.89200 },
    Waypoint { name: "canaan contour 038", lat: 32.56713, lon: 34.87859 },
    Waypoint { name: "canaan contour 039", lat: 32.54303, lon: 34.87662 },
    Waypoint { name: "canaan contour 040", lat: 32.49567, lon: 34.86378 },
    Waypoint { name: "canaan contour 041", lat: 32.47954, lon: 34.85455 },
    Waypoint { name: "canaan contour 042", lat: 32.44762, lon: 34.85242 },
    Waypoint { name: "canaan contour 043", lat: 32.40944, lon: 34.83680 },
    Waypoint { name: "canaan contour 044", lat: 32.31139, lon: 34.81403 },
    Waypoint { name: "canaan contour 045", lat: 32.07747, lon: 34.73356 },
    Waypoint { name: "canaan contour 046", lat: 32.05626, lon: 34.71680 },
    Waypoint { name: "canaan contour 047", lat: 31.95781, lon: 34.68065 },
    Waypoint { name: "canaan contour 048", lat: 31.93594, lon: 34.66462 },
    Waypoint { name: "canaan contour 049", lat: 31.86546, lon: 34.63201 },
    Waypoint { name: "canaan contour 050", lat: 31.84173, lon: 34.61074 },
    Waypoint { name: "canaan contour 051", lat: 31.82420, lon: 34.60667 },
    Waypoint { name: "canaan contour 052", lat: 31.77253, lon: 34.57964 },
    Waypoint { name: "canaan contour 053", lat: 31.67015, lon: 34.51000 },
    Waypoint { name: "canaan contour 054", lat: 31.54422, lon: 34.40869 },
    Waypoint { name: "canaan contour 055", lat: 31.49685, lon: 34.36169 },
    Waypoint { name: "canaan contour 056", lat: 31.48393, lon: 34.35475 },
    Waypoint { name: "canaan contour 057", lat: 31.46300, lon: 34.35804 },
    Waypoint { name: "canaan contour 058", lat: 31.44164, lon: 34.38434 },
    Waypoint { name: "canaan contour 059", lat: 31.45957, lon: 34.40178 },
    ...
    Waypoint { name: "canaan contour 065", lat: 31.35328, lon: 34.47093 },
    ...
    Waypoint { name: "canaan contour 069", lat: 31.22614, lon: 34.50401 },
    Waypoint { name: "canaan contour 070", lat: 31.22126, lon: 34.52099 },
    Waypoint { name: "canaan contour 071", lat: 31.20006, lon: 34.53839 },
    Waypoint { name: "canaan contour 072", lat: 31.18824, lon: 34.57751 },
    Waypoint { name: "canaan contour 073", lat: 31.18022, lon: 34.58774 },
    Waypoint { name: "canaan contour 074", lat: 31.17304, lon: 34.58834 },
    Waypoint { name: "canaan contour 075", lat: 31.15319, lon: 34.60353 },
    Waypoint { name: "canaan contour 076", lat: 31.13176, lon: 34.63355 },
    Waypoint { name: "canaan contour 077", lat: 31.11404, lon: 34.67403 },
    Waypoint { name: "canaan contour 078", lat: 31.09315, lon: 34.74490 },
    Waypoint { name: "canaan contour 079", lat: 31.05886, lon: 34.90387 },
    Waypoint { name: "canaan contour 080", lat: 31.04070, lon: 34.96811 },
    Waypoint { name: "canaan contour 081", lat: 31.01336, lon: 35.03513 },
    Waypoint { name: "canaan contour 082", lat: 30.95568, lon: 35.22407 },
    Waypoint { name: "canaan contour 083", lat: 30.92763, lon: 35.29405 },
    Waypoint { name: "canaan contour 084", lat: 30.91014, lon: 35.32266 },
    Waypoint { name: "canaan contour 085", lat: 30.91478, lon: 35.35320 },
    Waypoint { name: "canaan contour 086", lat: 30.92881, lon: 35.37057 },
    Waypoint { name: "canaan contour 087", lat: 30.94825, lon: 35.37690 },
    Waypoint { name: "canaan contour 088", lat: 31.00429, lon: 35.37951 },
    Waypoint { name: "canaan contour 089", lat: 31.02568, lon: 35.38663 },
    Waypoint { name: "canaan contour 090", lat: 31.03147, lon: 35.39046 },
    Waypoint { name: "canaan contour 091", lat: 31.03018, lon: 35.42459 },
    Waypoint { name: "canaan contour 092", lat: 31.04569, lon: 35.43233 },
    Waypoint { name: "canaan contour 093", lat: 31.05808, lon: 35.43258 },
    Waypoint { name: "canaan contour 094", lat: 31.07190, lon: 35.42543 },
    Waypoint { name: "canaan contour 095", lat: 31.08427, lon: 35.39227 },
    Waypoint { name: "canaan contour 096", lat: 31.12617, lon: 35.38346 },
    Waypoint { name: "canaan contour 097", lat: 31.15130, lon: 35.36466 },
    Waypoint { name: "canaan contour 098", lat: 31.20034, lon: 35.35822 },
    Waypoint { name: "canaan contour 099", lat: 31.21394, lon: 35.36295 },
    Waypoint { name: "canaan contour 100", lat: 31.25579, lon: 35.39201 },
    Waypoint { name: "canaan contour 101", lat: 31.28431, lon: 35.40150 },
    Waypoint { name: "canaan contour 102", lat: 31.30191, lon: 35.40185 },
    Waypoint { name: "canaan contour 103", lat: 31.32120, lon: 35.41635 },
    Waypoint { name: "canaan contour 104", lat: 31.36632, lon: 35.40984 },
    Waypoint { name: "canaan contour 105", lat: 31.40836, lon: 35.39360 },
    Waypoint { name: "canaan contour 106", lat: 31.44538, lon: 35.40178 },
    Waypoint { name: "canaan contour 107", lat: 31.50802, lon: 35.40007 },
    Waypoint { name: "canaan contour 108", lat: 31.52100, lon: 35.40330 },
    Waypoint { name: "canaan contour 109", lat: 31.54741, lon: 35.42091 },
    Waypoint { name: "canaan contour 110", lat: 31.58728, lon: 35.41652 },
    Waypoint { name: "canaan contour 111", lat: 31.60260, lon: 35.43391 },
    Waypoint { name: "canaan contour 112", lat: 31.61755, lon: 35.43644 },
    Waypoint { name: "canaan contour 113", lat: 31.64531, lon: 35.45185 },
    Waypoint { name: "canaan contour 114", lat: 31.67071, lon: 35.45385 },
    Waypoint { name: "canaan contour 115", lat: 31.68138, lon: 35.47560 },
    Waypoint { name: "canaan contour 116", lat: 31.72330, lon: 35.50095 },
    Waypoint { name: "canaan contour 117", lat: 31.72386, lon: 35.54032 },
    Waypoint { name: "canaan contour 118", lat: 31.73018, lon: 35.55158 },
    Waypoint { name: "canaan contour 119", lat: 31.74373, lon: 35.55928 },
    Waypoint { name: "canaan contour 120", lat: 31.80653, lon: 35.54867 },
    Waypoint { name: "canaan contour 121", lat: 31.82472, lon: 35.55275 },
    Waypoint { name: "canaan contour 122", lat: 31.85935, lon: 35.54899 },
    Waypoint { name: "canaan contour 123", lat: 31.86450, lon: 35.55281 },
    Waypoint { name: "canaan contour 124", lat: 31.90533, lon: 35.53135 },
    Waypoint { name: "canaan contour 125", lat: 31.91768, lon: 35.53383 },
    Waypoint { name: "canaan contour 126", lat: 31.93562, lon: 35.55053 },
    Waypoint { name: "canaan contour 127", lat: 31.96366, lon: 35.55110 },
    Waypoint { name: "canaan contour 128", lat: 31.98405, lon: 35.54185 },
    Waypoint { name: "canaan contour 129", lat: 31.99645, lon: 35.54136 },
    Waypoint { name: "canaan contour 130", lat: 32.00834, lon: 35.53343 },
    Waypoint { name: "canaan contour 131", lat: 32.03977, lon: 35.52664 },
    Waypoint { name: "canaan contour 132", lat: 32.05006, lon: 35.53427 },
    Waypoint { name: "canaan contour 133", lat: 32.06566, lon: 35.53682 },
    Waypoint { name: "canaan contour 134", lat: 32.08171, lon: 35.55051 },
    Waypoint { name: "canaan contour 135", lat: 32.10665, lon: 35.54210 },
    Waypoint { name: "canaan contour 136", lat: 32.14991, lon: 35.56525 },
    Waypoint { name: "canaan contour 137", lat: 32.16888, lon: 35.56192 },
    Waypoint { name: "canaan contour 138", lat: 32.19146, lon: 35.57500 },
    Waypoint { name: "canaan contour 139", lat: 32.21031, lon: 35.57835 },
    Waypoint { name: "canaan contour 140", lat: 32.25145, lon: 35.57546 },
    Waypoint { name: "canaan contour 141", lat: 32.26793, lon: 35.56614 },
    Waypoint { name: "canaan contour 142", lat: 32.28477, lon: 35.57242 },
    Waypoint { name: "canaan contour 143", lat: 32.29728, lon: 35.56599 },
    Waypoint { name: "canaan contour 144", lat: 32.31028, lon: 35.56848 },
    Waypoint { name: "canaan contour 145", lat: 32.33131, lon: 35.56000 },
    Waypoint { name: "canaan contour 146", lat: 32.36768, lon: 35.56815 },
    Waypoint { name: "canaan contour 147", lat: 32.42185, lon: 35.56553 },
    Waypoint { name: "canaan contour 148", lat: 32.45749, lon: 35.57813 },
    Waypoint { name: "canaan contour 149", lat: 32.47390, lon: 35.57252 },
    Waypoint { name: "canaan contour 150", lat: 32.48801, lon: 35.58469 },
    Waypoint { name: "canaan contour 151", lat: 32.51051, lon: 35.56732 },
    Waypoint { name: "canaan contour 152", lat: 32.53520, lon: 35.57228 },
    Waypoint { name: "canaan contour 153", lat: 32.55133, lon: 35.58151 },
    Waypoint { name: "canaan contour 154", lat: 32.59762, lon: 35.58245 },
    Waypoint { name: "canaan contour 155", lat: 32.62457, lon: 35.57111 },
    Waypoint { name: "canaan contour 156", lat: 32.65450, lon: 35.57468 },
    Waypoint { name: "canaan contour 157", lat: 32.67878, lon: 35.56700 },
    Waypoint { name: "canaan contour 158", lat: 32.68840, lon: 35.57537 },
    Waypoint { name: "canaan contour 159", lat: 32.70531, lon: 35.57793 },
    Waypoint { name: "canaan contour 160", lat: 32.71018, lon: 35.59660 },
    Waypoint { name: "canaan contour 161", lat: 32.73560, lon: 35.59711 },
    Waypoint { name: "canaan contour 162", lat: 32.76247, lon: 35.59023 },
    Waypoint { name: "canaan contour 163", lat: 32.78297, lon: 35.57505 },
    Waypoint { name: "canaan contour 164", lat: 32.80985, lon: 35.56742 },
    Waypoint { name: "canaan contour 165", lat: 32.82843, lon: 35.55071 },
    Waypoint { name: "canaan contour 166", lat: 32.83625, lon: 35.55087 },
    Waypoint { name: "canaan contour 167", lat: 32.85171, lon: 35.56084 },
    Waypoint { name: "canaan contour 168", lat: 32.87182, lon: 35.60134 },
    Waypoint { name: "canaan contour 169", lat: 32.87218, lon: 35.61694 },
    Waypoint { name: "canaan contour 170", lat: 32.87971, lon: 35.63269 },
    Waypoint { name: "canaan contour 171", lat: 32.89358, lon: 35.62332 },
    Waypoint { name: "canaan contour 172", lat: 32.90653, lon: 35.62878 },
    Waypoint { name: "canaan contour 173", lat: 33.03423, lon: 35.63506 },
    Waypoint { name: "canaan contour 174", lat: 33.05189, lon: 35.63245 },
    Waypoint { name: "canaan contour 175", lat: 33.05570, lon: 35.63773 },
    Waypoint { name: "canaan contour 176", lat: 33.07784, lon: 35.63966 },
    Waypoint { name: "canaan contour 177", lat: 33.09522, lon: 35.65189 },
    Waypoint { name: "canaan contour 178", lat: 33.14791, lon: 35.65889 },
    Waypoint { name: "canaan contour 179", lat: 33.16689, lon: 35.65556 },
    Waypoint { name: "canaan contour 180", lat: 33.18009, lon: 35.64692 },
    Waypoint { name: "canaan contour 181", lat: 33.20417, lon: 35.64963 },
    Waypoint { name: "canaan contour 182", lat: 33.22061, lon: 35.64254 },
    Waypoint { name: "canaan contour 183", lat: 33.22506, lon: 35.61367 },
    Waypoint { name: "canaan contour 184", lat: 33.23420, lon: 35.61311 },
    Waypoint { name: "canaan contour 185", lat: 33.25412, lon: 35.62910 },
    Waypoint { name: "canaan contour 186", lat: 33.29595, lon: 35.62401 },
    Waypoint { name: "canaan contour 187", lat: 33.32364, lon: 35.64313 },
    Waypoint { name: "canaan contour 188", lat: 33.36805, lon: 35.63957 },
    Waypoint { name: "canaan contour 189", lat: 33.41712, lon: 35.66581 },
    Waypoint { name: "canaan contour 190", lat: 33.42736, lon: 35.67641 },
    Waypoint { name: "canaan contour 191", lat: 33.43485, lon: 35.69438 },
    Waypoint { name: "canaan contour 192", lat: 33.44345, lon: 35.68787 },
    Waypoint { name: "canaan contour 193", lat: 33.45370, lon: 35.66283 },
];
