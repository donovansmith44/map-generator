...
const PLATE_CANAAN_CONTOUR: &[Waypoint] = &[
    ...
    Waypoint { name: "canaan contour 016", lat: 32.64624, lon: 35.18094 },
    Waypoint { name: "canaan contour 017", lat: 32.65443, lon: 35.16105 },
    Waypoint { name: "canaan contour 018", lat: 32.67372, lon: 35.14139 },
    Waypoint { name: "canaan contour 019", lat: 32.68983, lon: 35.11647 },
    Waypoint { name: "canaan contour 020", lat: 32.70039, lon: 35.11000 },
    Waypoint { name: "canaan contour 021", lat: 32.74227, lon: 35.10268 },
    Waypoint { name: "canaan contour 022", lat: 32.76893, lon: 35.07202 },
    Waypoint { name: "canaan contour 023", lat: 32.79179, lon: 35.07026 },
    Waypoint { name: "canaan contour 024", lat: 32.80852, lon: 35.04757 },
    Waypoint { name: "canaan contour 025", lat: 32.81373, lon: 35.04768 },
    Waypoint { name: "canaan contour 026", lat: 32.82323, lon: 35.06272 },
    Waypoint { name: "canaan contour 027", lat: 32.84113, lon: 35.04749 },
    Waypoint { name: "canaan contour 028", lat: 32.84394, lon: 35.03641 },
    Waypoint { name: "canaan contour 029", lat: 32.86333, lon: 35.01081 },
    Waypoint { name: "canaan contour 030", lat: 32.86819, lon: 34.99531 },
    Waypoint { name: "canaan contour 031", lat: 32.86281, lon: 34.96921 },
    Waypoint { name: "canaan contour 032", lat: 32.84816, lon: 34.95035 },
    Waypoint { name: "canaan contour 033", lat: 32.80139, lon: 34.94050 },
    Waypoint { name: "canaan contour 034", lat: 32.77270, lon: 34.94066 },
    Waypoint { name: "canaan contour 035", lat: 32.73310, lon: 34.93095 },
    Waypoint { name: "canaan contour 036", lat: 32.70993, lon: 34.91415 },
    Waypoint { name: "canaan contour 037", lat: 32.67277, lon: 34.91340 },
    Waypoint { name: "canaan contour 038", lat: 32.65401, lon: 34.90559 },
    Waypoint { name: "canaan contour 039", lat: 32.60521, lon: 34.89941 },
    Waypoint { name: "canaan contour 040", lat: 32.56633, lon: 34.88600 },
    Waypoint { name: "canaan contour 041", lat: 32.54549, lon: 34.88484 },
    Waypoint { name: "canaan contour 042", lat: 32.49292, lon: 34.87115 },
    Waypoint { name: "canaan contour 043", lat: 32.47874, lon: 34.86196 },
    Waypoint { name: "canaan contour 044", lat: 32.44683, lon: 34.85983 },
    Waypoint { name: "canaan contour 045", lat: 32.40864, lon: 34.84421 },
    Waypoint { name: "canaan contour 046", lat: 32.31060, lon: 34.82144 },
    Waypoint { name: "canaan contour 047", lat: 32.15769, lon: 34.76786 },
    Waypoint { name: "canaan contour 048", lat: 32.14271, lon: 34.76681 },
    Waypoint { name: "canaan contour 049", lat: 32.10264, lon: 34.74744 },
    Waypoint { name: "canaan contour 050", lat: 32.07473, lon: 34.74019 },
    Waypoint { name: "canaan contour 051", lat: 32.05158, lon: 34.72264 },
    Waypoint { name: "canaan contour 052", lat: 31.95637, lon: 34.68805 },
    Waypoint { name: "canaan contour 053", lat: 31.93449, lon: 34.67201 },
    Waypoint { name: "canaan contour 054", lat: 31.86208, lon: 34.63862 },
    Waypoint { name: "canaan contour 055", lat: 31.84029, lon: 34.61813 },
    Waypoint { name: "canaan contour 056", lat: 31.82470, lon: 34.61485 },
    Waypoint { name: "canaan contour 057", lat: 31.76851, lon: 34.58550 },
    Waypoint { name: "canaan contour 058", lat: 31.66612, lon: 34.51585 },
    Waypoint { name: "canaan contour 059", lat: 31.54084, lon: 34.41531 },
    Waypoint { name: "canaan contour 060", lat: 31.48314, lon: 34.36216 },
    Waypoint { name: "canaan contour 061", lat: 31.46680, lon: 34.36406 },
    Waypoint { name: "canaan contour 062", lat: 31.45748, lon: 34.37427 },
    Waypoint { name: "canaan contour 063", lat: 31.45405, lon: 34.38311 },
    Waypoint { name: "canaan contour 064", lat: 31.46623, lon: 34.39449 },
    Waypoint { name: "canaan contour 065", lat: 31.46611, lon: 34.40117 },
    Waypoint { name: "canaan contour 066", lat: 31.46011, lon: 34.40774 },
    Waypoint { name: "canaan contour 067", lat: 31.43515, lon: 34.41763 },
    Waypoint { name: "canaan contour 068", lat: 31.42582, lon: 34.42784 },
    Waypoint { name: "canaan contour 069", lat: 31.40360, lon: 34.43036 },
    Waypoint { name: "canaan contour 070", lat: 31.37901, lon: 34.45511 },
    Waypoint { name: "canaan contour 071", lat: 31.35328, lon: 34.47093 },
    Waypoint { name: "canaan contour 072", lat: 31.32634, lon: 34.48153 },
    Waypoint { name: "canaan contour 073", lat: 31.29444, lon: 34.47865 },
    Waypoint { name: "canaan contour 074", lat: 31.25252, lon: 34.48821 },
    Waypoint { name: "canaan contour 075", lat: 31.22614, lon: 34.50401 },
    Waypoint { name: "canaan contour 076", lat: 31.22126, lon: 34.52099 },
    Waypoint { name: "canaan contour 077", lat: 31.20006, lon: 34.53839 },
    Waypoint { name: "canaan contour 078", lat: 31.18824, lon: 34.57751 },
    Waypoint { name: "canaan contour 079", lat: 31.18022, lon: 34.58774 },
    Waypoint { name: "canaan contour 080", lat: 31.17304, lon: 34.58834 },
    Waypoint { name: "canaan contour 081", lat: 31.15319, lon: 34.60353 },
    Waypoint { name: "canaan contour 082", lat: 31.13176, lon: 34.63355 },
    Waypoint { name: "canaan contour 083", lat: 31.11404, lon: 34.67403 },
    Waypoint { name: "canaan contour 084", lat: 31.09315, lon: 34.74490 },
    Waypoint { name: "canaan contour 085", lat: 31.05886, lon: 34.90387 },
    Waypoint { name: "canaan contour 086", lat: 31.04070, lon: 34.96811 },
    Waypoint { name: "canaan contour 087", lat: 31.01336, lon: 35.03513 },
    Waypoint { name: "canaan contour 088", lat: 30.95568, lon: 35.22407 },
    Waypoint { name: "canaan contour 089", lat: 30.92763, lon: 35.29405 },
    Waypoint { name: "canaan contour 090", lat: 30.91014, lon: 35.32266 },
    Waypoint { name: "canaan contour 091", lat: 30.91478, lon: 35.35320 },
    Waypoint { name: "canaan contour 092", lat: 30.92881, lon: 35.37057 },
    Waypoint { name: "canaan contour 093", lat: 30.94825, lon: 35.37690 },
    Waypoint { name: "canaan contour 094", lat: 31.00429, lon: 35.37951 },
    Waypoint { name: "canaan contour 095", lat: 31.02568, lon: 35.38663 },
    Waypoint { name: "canaan contour 096", lat: 31.03984, lon: 35.39657 },
    Waypoint { name: "canaan contour 097", lat: 31.03873, lon: 35.42105 },
    Waypoint { name: "canaan contour 098", lat: 31.04648, lon: 35.42492 },
    Waypoint { name: "canaan contour 099", lat: 31.06018, lon: 35.42446 },
    Waypoint { name: "canaan contour 100", lat: 31.07078, lon: 35.41576 },
    Waypoint { name: "canaan contour 101", lat: 31.07983, lon: 35.38549 },
    Waypoint { name: "canaan contour 102", lat: 31.12172, lon: 35.37743 },
    Waypoint { name: "canaan contour 103", lat: 31.14017, lon: 35.36740 },
    Waypoint { name: "canaan contour 104", lat: 31.14753, lon: 35.35716 },
    Waypoint { name: "canaan contour 105", lat: 31.19982, lon: 35.35078 },
    Waypoint { name: "canaan contour 106", lat: 31.21475, lon: 35.35480 },
    Waypoint { name: "canaan contour 107", lat: 31.26046, lon: 35.38617 },
    Waypoint { name: "canaan contour 108", lat: 31.28510, lon: 35.39409 },
    Waypoint { name: "canaan contour 109", lat: 31.30465, lon: 35.39448 },
    Waypoint { name: "canaan contour 110", lat: 31.32199, lon: 35.40894 },
    Waypoint { name: "canaan contour 111", lat: 31.33765, lon: 35.40852 },
    Waypoint { name: "canaan contour 112", lat: 31.34690, lon: 35.40202 },
    Waypoint { name: "canaan contour 113", lat: 31.36843, lon: 35.40171 },
    Waypoint { name: "canaan contour 114", lat: 31.40852, lon: 35.38544 },
    Waypoint { name: "canaan contour 115", lat: 31.44617, lon: 35.39437 },
    Waypoint { name: "canaan contour 116", lat: 31.50881, lon: 35.39266 },
    Waypoint { name: "canaan contour 117", lat: 31.52375, lon: 35.39593 },
    Waypoint { name: "canaan contour 118", lat: 31.54820, lon: 35.41350 },
    Waypoint { name: "canaan contour 119", lat: 31.58872, lon: 35.40912 },
    Waypoint { name: "canaan contour 120", lat: 31.60728, lon: 35.42806 },
    Waypoint { name: "canaan contour 121", lat: 31.62094, lon: 35.42982 },
    Waypoint { name: "canaan contour 122", lat: 31.64610, lon: 35.44444 },
    Waypoint { name: "canaan contour 123", lat: 31.67732, lon: 35.44878 },
    Waypoint { name: "canaan contour 124", lat: 31.68797, lon: 35.47202 },
    Waypoint { name: "canaan contour 125", lat: 31.73055, lon: 35.49664 },
    Waypoint { name: "canaan contour 126", lat: 31.72918, lon: 35.53523 },
    Waypoint { name: "canaan contour 127", lat: 31.73676, lon: 35.54800 },
    Waypoint { name: "canaan contour 128", lat: 31.74452, lon: 35.55187 },
    Waypoint { name: "canaan contour 129", lat: 31.76546, lon: 35.54784 },
    Waypoint { name: "canaan contour 130", lat: 31.76394, lon: 35.52479 },
    Waypoint { name: "canaan contour 131", lat: 31.78350, lon: 35.52518 },
    Waypoint { name: "canaan contour 132", lat: 31.79340, lon: 35.51870 },
    Waypoint { name: "canaan contour 133", lat: 31.86114, lon: 35.52304 },
    Waypoint { name: "canaan contour 134", lat: 31.87037, lon: 35.51802 },
    Waypoint { name: "canaan contour 135", lat: 31.87178, lon: 35.51211 },
    Waypoint { name: "canaan contour 136", lat: 31.89145, lon: 35.50657 },
    Waypoint { name: "canaan contour 137", lat: 31.90969, lon: 35.50768 },
    Waypoint { name: "canaan contour 138", lat: 31.91601, lon: 35.51820 },
    Waypoint { name: "canaan contour 139", lat: 31.95312, lon: 35.52192 },
    Waypoint { name: "canaan contour 140", lat: 32.02523, lon: 35.50184 },
    Waypoint { name: "canaan contour 141", lat: 32.04218, lon: 35.50218 },
    Waypoint { name: "canaan contour 142", lat: 32.04593, lon: 35.51117 },
    Waypoint { name: "canaan contour 143", lat: 32.07503, lon: 35.52438 },
    Waypoint { name: "canaan contour 144", lat: 32.10376, lon: 35.52199 },
    Waypoint { name: "canaan contour 145", lat: 32.11272, lon: 35.53108 },
    Waypoint { name: "canaan contour 146", lat: 32.13556, lon: 35.53080 },
    Waypoint { name: "canaan contour 147", lat: 32.14121, lon: 35.54205 },
    Waypoint { name: "canaan contour 148", lat: 32.16735, lon: 35.53961 },
    Waypoint { name: "canaan contour 149", lat: 32.17901, lon: 35.54356 },
    Waypoint { name: "canaan contour 150", lat: 32.18601, lon: 35.55261 },
    Waypoint { name: "canaan contour 151", lat: 32.20554, lon: 35.55449 },
    Waypoint { name: "canaan contour 152", lat: 32.21997, lon: 35.55032 },
    Waypoint { name: "canaan contour 153", lat: 32.24274, lon: 35.55301 },
    Waypoint { name: "canaan contour 154", lat: 32.25263, lon: 35.54727 },
    Waypoint { name: "canaan contour 155", lat: 32.27929, lon: 35.55152 },
    Waypoint { name: "canaan contour 156", lat: 32.28592, lon: 35.54571 },
    Waypoint { name: "canaan contour 157", lat: 32.30808, lon: 35.54690 },
    Waypoint { name: "canaan contour 158", lat: 32.31337, lon: 35.54255 },
    Waypoint { name: "canaan contour 159", lat: 32.36225, lon: 35.54428 },
    Waypoint { name: "canaan contour 160", lat: 32.36345, lon: 35.55025 },
    Waypoint { name: "canaan contour 161", lat: 32.36865, lon: 35.55109 },
    Waypoint { name: "canaan contour 162", lat: 32.38445, lon: 35.54324 },
    Waypoint { name: "canaan contour 163", lat: 32.40009, lon: 35.54356 },
    Waypoint { name: "canaan contour 164", lat: 32.40131, lon: 35.54804 },
    Waypoint { name: "canaan contour 165", lat: 32.43978, lon: 35.54882 },
    Waypoint { name: "canaan contour 166", lat: 32.44027, lon: 35.55699 },
    Waypoint { name: "canaan contour 167", lat: 32.45197, lon: 35.55946 },
    Waypoint { name: "canaan contour 168", lat: 32.47483, lon: 35.55769 },
    Waypoint { name: "canaan contour 169", lat: 32.48509, lon: 35.56681 },
    Waypoint { name: "canaan contour 170", lat: 32.48965, lon: 35.56690 },
    Waypoint { name: "canaan contour 171", lat: 32.49906, lon: 35.55224 },
    Waypoint { name: "canaan contour 172", lat: 32.54145, lon: 35.55235 },
    Waypoint { name: "canaan contour 173", lat: 32.55031, lon: 35.56664 },
    Waypoint { name: "canaan contour 174", lat: 32.58938, lon: 35.56966 },
    Waypoint { name: "canaan contour 175", lat: 32.59471, lon: 35.56382 },
    Waypoint { name: "canaan contour 176", lat: 32.61361, lon: 35.56420 },
    Waypoint { name: "canaan contour 177", lat: 32.61893, lon: 35.55911 },
    Waypoint { name: "canaan contour 178", lat: 32.65735, lon: 35.56212 },
    Waypoint { name: "canaan contour 179", lat: 32.66860, lon: 35.55343 },
    Waypoint { name: "canaan contour 180", lat: 32.68555, lon: 35.55377 },
    Waypoint { name: "canaan contour 181", lat: 32.69387, lon: 35.56211 },
    Waypoint { name: "canaan contour 182", lat: 32.68890, lon: 35.58354 },
    Waypoint { name: "canaan contour 183", lat: 32.70194, lon: 35.58381 },
    Waypoint { name: "canaan contour 184", lat: 32.71097, lon: 35.58919 },
    Waypoint { name: "canaan contour 185", lat: 32.75473, lon: 35.58561 },
    Waypoint { name: "canaan contour 186", lat: 32.77984, lon: 35.56830 },
    Waypoint { name: "canaan contour 187", lat: 32.80342, lon: 35.56283 },
    Waypoint { name: "canaan contour 188", lat: 32.82529, lon: 35.54397 },
    Waypoint { name: "canaan contour 189", lat: 32.83445, lon: 35.54267 },
    Waypoint { name: "canaan contour 190", lat: 32.85703, lon: 35.55575 },
    Waypoint { name: "canaan contour 191", lat: 32.86382, lon: 35.57593 },
    Waypoint { name: "canaan contour 192", lat: 32.87838, lon: 35.59925 },
    Waypoint { name: "canaan contour 193", lat: 32.88120, lon: 35.62307 },
    Waypoint { name: "canaan contour 194", lat: 32.89922, lon: 35.63605 },
    Waypoint { name: "canaan contour 195", lat: 32.91063, lon: 35.61846 },
    Waypoint { name: "canaan contour 196", lat: 33.01030, lon: 35.62419 },
    Waypoint { name: "canaan contour 197", lat: 33.03438, lon: 35.62690 },
    Waypoint { name: "canaan contour 198", lat: 33.03922, lon: 35.64705 },
    Waypoint { name: "canaan contour 199", lat: 33.05090, lon: 35.65025 },
    Waypoint { name: "canaan contour 200", lat: 33.07475, lon: 35.63068 },
    Waypoint { name: "canaan contour 201", lat: 33.08061, lon: 35.63080 },
    Waypoint { name: "canaan contour 202", lat: 33.09018, lon: 35.64213 },
    Waypoint { name: "canaan contour 203", lat: 33.10382, lon: 35.64538 },
    Waypoint { name: "canaan contour 204", lat: 33.11268, lon: 35.62477 },
    Waypoint { name: "canaan contour 205", lat: 33.15370, lon: 35.62856 },
    Waypoint { name: "canaan contour 206", lat: 33.17352, lon: 35.61485 },
    Waypoint { name: "canaan contour 207", lat: 33.20082, lon: 35.61986 },
    Waypoint { name: "canaan contour 208", lat: 33.21399, lon: 35.61270 },
    Waypoint { name: "canaan contour 209", lat: 33.23420, lon: 35.61311 },
    Waypoint { name: "canaan contour 210", lat: 33.25412, lon: 35.62910 },
    Waypoint { name: "canaan contour 211", lat: 33.29595, lon: 35.62401 },
    Waypoint { name: "canaan contour 212", lat: 33.32364, lon: 35.64313 },
    Waypoint { name: "canaan contour 213", lat: 33.36805, lon: 35.63957 },
    Waypoint { name: "canaan contour 214", lat: 33.41712, lon: 35.66581 },
    Waypoint { name: "canaan contour 215", lat: 33.42736, lon: 35.67641 },
    Waypoint { name: "canaan contour 216", lat: 33.43485, lon: 35.69438 },
    Waypoint { name: "canaan contour 217", lat: 33.44345, lon: 35.68787 },
    Waypoint { name: "canaan contour 218", lat: 33.45370, lon: 35.66283 },
];
