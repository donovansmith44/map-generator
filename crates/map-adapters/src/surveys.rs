...
const PLATE_CANAAN_CONTOUR: &[Waypoint] = &[
    Waypoint { name: "canaan contour 000", lat: 33.46284, lon: 35.66227 },
    Waypoint { name: "canaan contour 001", lat: 33.43047, lon: 35.61484 },
    Waypoint { name: "canaan contour 002", lat: 33.40534, lon: 35.59874 },
    Waypoint { name: "canaan contour 003", lat: 33.40259, lon: 35.57120 },
    Waypoint { name: "canaan contour 004", lat: 33.37949, lon: 35.55143 },
    Waypoint { name: "canaan contour 005", lat: 33.32295, lon: 35.54064 },
    Waypoint { name: "canaan contour 006", lat: 33.30685, lon: 35.52992 },
    Waypoint { name: "canaan contour 007", lat: 33.30539, lon: 35.53806 },
    Waypoint { name: "canaan contour 008", lat: 33.29951, lon: 35.53868 },
    Waypoint { name: "canaan contour 009", lat: 33.11092, lon: 35.47547 },
    Waypoint { name: "canaan contour 010", lat: 33.00735, lon: 35.43402 },
    Waypoint { name: "canaan contour 011", lat: 32.99978, lon: 35.42050 },
    Waypoint { name: "canaan contour 012", lat: 32.98537, lon: 35.42392 },
    Waypoint { name: "canaan contour 013", lat: 32.88583, lon: 35.37588 },
    Waypoint { name: "canaan contour 014", lat: 32.73422, lon: 35.28816 },
    Waypoint { name: "canaan contour 015", lat: 32.65823, lon: 35.23688 },
    Waypoint { name: "canaan contour 016", lat: 32.64743, lon: 35.22181 },
    Waypoint { name: "canaan contour 017", lat: 32.65742, lon: 35.17597 },
    Waypoint { name: "canaan contour 018", lat: 32.69289, lon: 35.12767 },
    Waypoint { name: "canaan contour 019", lat: 32.70477, lon: 35.11974 },
    Waypoint { name: "canaan contour 020", lat: 32.74600, lon: 35.11240 },
    Waypoint { name: "canaan contour 021", lat: 32.77199, lon: 35.08248 },
    Waypoint { name: "canaan contour 022", lat: 32.79750, lon: 35.07854 },
    Waypoint { name: "canaan contour 023", lat: 32.81897, lon: 35.04630 },
    Waypoint { name: "canaan contour 024", lat: 32.83211, lon: 35.04137 },
    Waypoint { name: "canaan contour 025", lat: 32.83426, lon: 35.03101 },
    Waypoint { name: "canaan contour 026", lat: 32.85776, lon: 34.99510 },
    Waypoint { name: "canaan contour 027", lat: 32.85357, lon: 34.97497 },
    Waypoint { name: "canaan contour 028", lat: 32.84275, lon: 34.96064 },
    Waypoint { name: "canaan contour 029", lat: 32.79987, lon: 34.95235 },
    Waypoint { name: "canaan contour 030", lat: 32.77117, lon: 34.95251 },
    Waypoint { name: "canaan contour 031", lat: 32.72831, lon: 34.94274 },
    Waypoint { name: "canaan contour 032", lat: 32.70841, lon: 34.92600 },
    Waypoint { name: "canaan contour 033", lat: 32.67125, lon: 34.92525 },
    Waypoint { name: "canaan contour 034", lat: 32.65248, lon: 34.91744 },
    Waypoint { name: "canaan contour 035", lat: 32.60369, lon: 34.91126 },
    Waypoint { name: "canaan contour 036", lat: 32.56481, lon: 34.89785 },
    Waypoint { name: "canaan contour 037", lat: 32.48878, lon: 34.88295 },
    Waypoint { name: "canaan contour 038", lat: 32.47722, lon: 34.87381 },
    Waypoint { name: "canaan contour 039", lat: 32.44206, lon: 34.87087 },
    Waypoint { name: "canaan contour 040", lat: 32.40712, lon: 34.85606 },
    Waypoint { name: "canaan contour 041", lat: 32.31101, lon: 34.83407 },
    Waypoint { name: "canaan contour 042", lat: 32.17554, lon: 34.78975 },
    Waypoint { name: "canaan contour 043", lat: 32.15357, lon: 34.77891 },
    Waypoint { name: "canaan contour 044", lat: 32.14053, lon: 34.77865 },
    Waypoint { name: "canaan contour 045", lat: 32.09852, lon: 34.75849 },
    Waypoint { name: "canaan contour 046", lat: 32.07061, lon: 34.75125 },
    Waypoint { name: "canaan contour 047", lat: 32.04941, lon: 34.73448 },
    Waypoint { name: "canaan contour 048", lat: 31.94901, lon: 34.69756 },
    Waypoint { name: "canaan contour 049", lat: 31.92908, lon: 34.68230 },
    Waypoint { name: "canaan contour 050", lat: 31.85473, lon: 34.64813 },
    Waypoint { name: "canaan contour 051", lat: 31.84900, lon: 34.64059 },
    Waypoint { name: "canaan contour 052", lat: 31.84119, lon: 34.63969 },
    Waypoint { name: "canaan contour 053", lat: 31.83488, lon: 34.62842 },
    Waypoint { name: "canaan contour 054", lat: 31.81735, lon: 34.62435 },
    Waypoint { name: "canaan contour 055", lat: 31.76310, lon: 34.59578 },
    Waypoint { name: "canaan contour 056", lat: 31.66071, lon: 34.52614 },
    Waypoint { name: "canaan contour 057", lat: 31.53543, lon: 34.42559 },
    Waypoint { name: "canaan contour 058", lat: 31.48162, lon: 34.37401 },
    Waypoint { name: "canaan contour 059", lat: 31.46984, lon: 34.37600 },
    Waypoint { name: "canaan contour 060", lat: 31.45242, lon: 34.40090 },
    Waypoint { name: "canaan contour 061", lat: 31.43405, lon: 34.40647 },
    Waypoint { name: "canaan contour 062", lat: 31.42146, lon: 34.41735 },
    Waypoint { name: "canaan contour 063", lat: 31.39987, lon: 34.42063 },
    Waypoint { name: "canaan contour 064", lat: 31.37330, lon: 34.44683 },
    Waypoint { name: "canaan contour 065", lat: 31.34691, lon: 34.46263 },
    Waypoint { name: "canaan contour 066", lat: 31.32393, lon: 34.47108 },
    Waypoint { name: "canaan contour 067", lat: 31.29268, lon: 34.46822 },
    Waypoint { name: "canaan contour 068", lat: 31.24485, lon: 34.47988 },
    Waypoint { name: "canaan contour 069", lat: 31.22043, lon: 34.49573 },
    Waypoint { name: "canaan contour 070", lat: 31.21421, lon: 34.51417 },
    Waypoint { name: "canaan contour 071", lat: 31.19436, lon: 34.52936 },
    Waypoint { name: "canaan contour 072", lat: 31.18119, lon: 34.57068 },
    Waypoint { name: "canaan contour 073", lat: 31.17191, lon: 34.57866 },
    Waypoint { name: "canaan contour 074", lat: 31.16908, lon: 34.59049 },
    Waypoint { name: "canaan contour 075", lat: 31.13983, lon: 34.62034 },
    Waypoint { name: "canaan contour 076", lat: 31.11404, lon: 34.67403 },
    Waypoint { name: "canaan contour 077", lat: 31.09175, lon: 34.75007 },
    ...
    Waypoint { name: "canaan contour 081", lat: 30.95019, lon: 35.23882 },
    Waypoint { name: "canaan contour 082", lat: 30.91817, lon: 35.31169 },
    Waypoint { name: "canaan contour 083", lat: 30.91350, lon: 35.31753 },
    Waypoint { name: "canaan contour 084", lat: 30.90444, lon: 35.31364 },
    Waypoint { name: "canaan contour 085", lat: 30.90101, lon: 35.32248 },
    Waypoint { name: "canaan contour 086", lat: 30.90624, lon: 35.35674 },
    Waypoint { name: "canaan contour 087", lat: 30.92471, lon: 35.38014 },
    Waypoint { name: "canaan contour 088", lat: 30.94610, lon: 35.38725 },
    Waypoint { name: "canaan contour 089", lat: 31.00604, lon: 35.39069 },
    Waypoint { name: "canaan contour 090", lat: 31.04801, lon: 35.41307 },
    Waypoint { name: "canaan contour 091", lat: 31.06177, lon: 35.40963 },
    Waypoint { name: "canaan contour 092", lat: 31.07023, lon: 35.37565 },
    Waypoint { name: "canaan contour 093", lat: 31.11998, lon: 35.36551 },
    Waypoint { name: "canaan contour 094", lat: 31.13515, lon: 35.35691 },
    Waypoint { name: "canaan contour 095", lat: 31.14449, lon: 35.34521 },
    Waypoint { name: "canaan contour 096", lat: 31.19809, lon: 35.33887 },
    Waypoint { name: "canaan contour 097", lat: 31.21048, lon: 35.33912 },
    Waypoint { name: "canaan contour 098", lat: 31.26652, lon: 35.37589 },
    Waypoint { name: "canaan contour 099", lat: 31.28662, lon: 35.38224 },
    Waypoint { name: "canaan contour 100", lat: 31.30814, lon: 35.38267 },
    Waypoint { name: "canaan contour 101", lat: 31.32352, lon: 35.39709 },
    Waypoint { name: "canaan contour 102", lat: 31.33395, lon: 35.39730 },
    Waypoint { name: "canaan contour 103", lat: 31.34582, lon: 35.39012 },
    Waypoint { name: "canaan contour 104", lat: 31.36473, lon: 35.39050 },
    Waypoint { name: "canaan contour 105", lat: 31.40548, lon: 35.37350 },
    Waypoint { name: "canaan contour 106", lat: 31.44770, lon: 35.38252 },
    Waypoint { name: "canaan contour 107", lat: 31.51099, lon: 35.38082 },
    Waypoint { name: "canaan contour 108", lat: 31.52787, lon: 35.38488 },
    Waypoint { name: "canaan contour 109", lat: 31.54973, lon: 35.40165 },
    Waypoint { name: "canaan contour 110", lat: 31.59090, lon: 35.39729 },
    Waypoint { name: "canaan contour 111", lat: 31.60946, lon: 35.41623 },
    Waypoint { name: "canaan contour 112", lat: 31.62248, lon: 35.41723 },
    Waypoint { name: "canaan contour 113", lat: 31.64763, lon: 35.43259 },
    Waypoint { name: "canaan contour 114", lat: 31.67304, lon: 35.43384 },
    Waypoint { name: "canaan contour 115", lat: 31.68273, lon: 35.43850 },
    Waypoint { name: "canaan contour 116", lat: 31.68850, lon: 35.44381 },
    Waypoint { name: "canaan contour 117", lat: 31.69338, lon: 35.46173 },
    Waypoint { name: "canaan contour 118", lat: 31.74114, lon: 35.48869 },
    Waypoint { name: "canaan contour 119", lat: 31.73907, lon: 35.52949 },
    Waypoint { name: "canaan contour 120", lat: 31.74604, lon: 35.54002 },
    Waypoint { name: "canaan contour 121", lat: 31.78526, lon: 35.53562 },
    Waypoint { name: "canaan contour 122", lat: 31.79646, lon: 35.52916 },
    Waypoint { name: "canaan contour 123", lat: 31.81008, lon: 35.53315 },
    Waypoint { name: "canaan contour 124", lat: 31.86290, lon: 35.53347 },
    Waypoint { name: "canaan contour 125", lat: 31.89386, lon: 35.51701 },
    Waypoint { name: "canaan contour 126", lat: 31.90429, lon: 35.51722 },
    Waypoint { name: "canaan contour 127", lat: 31.91711, lon: 35.52936 },
    Waypoint { name: "canaan contour 128", lat: 31.96206, lon: 35.53176 },
    Waypoint { name: "canaan contour 129", lat: 32.00146, lon: 35.51770 },
    Waypoint { name: "canaan contour 130", lat: 32.03547, lon: 35.51244 },
    Waypoint { name: "canaan contour 131", lat: 32.04183, lon: 35.52074 },
    Waypoint { name: "canaan contour 132", lat: 32.07287, lon: 35.53473 },
    Waypoint { name: "canaan contour 133", lat: 32.09966, lon: 35.53230 },
    Waypoint { name: "canaan contour 134", lat: 32.11057, lon: 35.54143 },
    Waypoint { name: "canaan contour 135", lat: 32.13015, lon: 35.54109 },
    Waypoint { name: "canaan contour 136", lat: 32.13906, lon: 35.55241 },
    Waypoint { name: "canaan contour 137", lat: 32.17427, lon: 35.55312 },
    Waypoint { name: "canaan contour 138", lat: 32.18386, lon: 35.56296 },
    Waypoint { name: "canaan contour 139", lat: 32.24451, lon: 35.56344 },
    Waypoint { name: "canaan contour 140", lat: 32.25505, lon: 35.55771 },
    Waypoint { name: "canaan contour 141", lat: 32.28105, lon: 35.56195 },
    Waypoint { name: "canaan contour 142", lat: 32.28899, lon: 35.55617 },
    Waypoint { name: "canaan contour 143", lat: 32.30984, lon: 35.55733 },
    Waypoint { name: "canaan contour 144", lat: 32.31579, lon: 35.55300 },
    Waypoint { name: "canaan contour 145", lat: 32.35489, lon: 35.55453 },
    Waypoint { name: "canaan contour 146", lat: 32.36064, lon: 35.56059 },
    Waypoint { name: "canaan contour 147", lat: 32.37041, lon: 35.56153 },
    Waypoint { name: "canaan contour 148", lat: 32.39338, lon: 35.55382 },
    Waypoint { name: "canaan contour 149", lat: 32.39916, lon: 35.55839 },
    Waypoint { name: "canaan contour 150", lat: 32.43111, lon: 35.55904 },
    Waypoint { name: "canaan contour 151", lat: 32.43618, lon: 35.56657 },
    Waypoint { name: "canaan contour 152", lat: 32.44982, lon: 35.56981 },
    Waypoint { name: "canaan contour 153", lat: 32.47202, lon: 35.56803 },
    Waypoint { name: "canaan contour 154", lat: 32.48294, lon: 35.57716 },
    Waypoint { name: "canaan contour 155", lat: 32.49338, lon: 35.57663 },
    Waypoint { name: "canaan contour 156", lat: 32.50343, lon: 35.56272 },
    Waypoint { name: "canaan contour 157", lat: 32.53604, lon: 35.56264 },
    Waypoint { name: "canaan contour 158", lat: 32.54816, lon: 35.57699 },
    Waypoint { name: "canaan contour 159", lat: 32.59114, lon: 35.58009 },
    Waypoint { name: "canaan contour 160", lat: 32.62264, lon: 35.56958 },
    Waypoint { name: "canaan contour 161", lat: 32.65911, lon: 35.57255 },
    Waypoint { name: "canaan contour 162", lat: 32.67166, lon: 35.56389 },
    Waypoint { name: "canaan contour 163", lat: 32.68209, lon: 35.56410 },
    Waypoint { name: "canaan contour 164", lat: 32.68978, lon: 35.57168 },
    Waypoint { name: "canaan contour 165", lat: 32.70673, lon: 35.57202 },
    Waypoint { name: "canaan contour 166", lat: 32.71249, lon: 35.57734 },
    Waypoint { name: "canaan contour 167", lat: 32.74119, lon: 35.57717 },
    Waypoint { name: "canaan contour 168", lat: 32.75760, lon: 35.57156 },
    Waypoint { name: "canaan contour 169", lat: 32.77613, lon: 35.55709 },
    Waypoint { name: "canaan contour 170", lat: 32.80103, lon: 35.55090 },
    Waypoint { name: "canaan contour 171", lat: 32.82489, lon: 35.53059 },
    Waypoint { name: "canaan contour 172", lat: 32.83663, lon: 35.53083 },
    Waypoint { name: "canaan contour 173", lat: 32.86694, lon: 35.54852 },
    Waypoint { name: "canaan contour 174", lat: 32.87306, lon: 35.57018 },
    Waypoint { name: "canaan contour 175", lat: 32.88887, lon: 35.59649 },
    Waypoint { name: "canaan contour 176", lat: 32.89044, lon: 35.61731 },
    Waypoint { name: "canaan contour 177", lat: 32.91564, lon: 35.62970 },
    Waypoint { name: "canaan contour 178", lat: 33.04982, lon: 35.63835 },
    Waypoint { name: "canaan contour 179", lat: 33.06505, lon: 35.62603 },
    Waypoint { name: "canaan contour 180", lat: 33.07518, lon: 35.60767 },
    Waypoint { name: "canaan contour 181", lat: 33.08300, lon: 35.60783 },
    Waypoint { name: "canaan contour 182", lat: 33.09559, lon: 35.63185 },
    Waypoint { name: "canaan contour 183", lat: 33.13524, lon: 35.63933 },
    Waypoint { name: "canaan contour 184", lat: 33.15873, lon: 35.63832 },
    Waypoint { name: "canaan contour 185", lat: 33.17593, lon: 35.62530 },
    Waypoint { name: "canaan contour 186", lat: 33.20258, lon: 35.63029 },
    Waypoint { name: "canaan contour 187", lat: 33.21248, lon: 35.62381 },
    Waypoint { name: "canaan contour 188", lat: 33.22944, lon: 35.62341 },
    Waypoint { name: "canaan contour 189", lat: 33.25197, lon: 35.63946 },
    Waypoint { name: "canaan contour 190", lat: 33.29380, lon: 35.63436 },
    Waypoint { name: "canaan contour 191", lat: 33.32149, lon: 35.65348 },
    Waypoint { name: "canaan contour 192", lat: 33.36396, lon: 35.64914 },
    Waypoint { name: "canaan contour 193", lat: 33.40917, lon: 35.67233 },
    Waypoint { name: "canaan contour 194", lat: 33.43270, lon: 35.70474 },
    Waypoint { name: "canaan contour 195", lat: 33.44580, lon: 35.70129 },
    Waypoint { name: "canaan contour 196", lat: 33.44145, lon: 35.69006 },
    Waypoint { name: "canaan contour 197", lat: 33.45158, lon: 35.67170 },
    Waypoint { name: "canaan contour 198", lat: 33.46066, lon: 35.67411 },
    Waypoint { name: "canaan contour 199", lat: 33.46283, lon: 35.66302 },
];
