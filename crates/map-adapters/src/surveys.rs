...
const JOS_15_CIRCUIT: &[Waypoint] = &[
    ...
    Waypoint { name: "judah deadsea reach 0.1", lat: 31.5950, lon: 35.5000 },
    Waypoint { name: "the Salt Sea under En-gedi", lat: 31.4500, lon: 35.4800 },
    Waypoint { name: "judah deadsea reach 1.1", lat: 31.3000, lon: 35.4900 },
    ...
    Waypoint { name: "judah south reach 0.1", lat: 30.9600, lon: 35.3750 },
    Waypoint { name: "the ascent of Akrabbim southward", lat: 30.9000, lon: 35.2500 },
    Waypoint { name: "judah south reach 1.1", lat: 30.8500, lon: 35.1167 },
    Waypoint { name: "judah south reach 1.2", lat: 30.8000, lon: 34.9833 },
    Waypoint { name: "the wilderness of Zin southward", lat: 30.7500, lon: 34.8500 },
    Waypoint { name: "judah south reach 2.1", lat: 30.7167, lon: 34.7333 },
    Waypoint { name: "judah south reach 2.2", lat: 30.6833, lon: 34.6167 },
    Waypoint { name: "toward Kadesh-barnea", lat: 30.6500, lon: 34.5000 },
    Waypoint { name: "judah south reach 3.1", lat: 30.6850, lon: 34.3750 },
    ...
    Waypoint { name: "judah simeon reach 6.2", lat: 30.9300, lon: 34.4200 },
    Waypoint { name: "judah simeon reach 6.1", lat: 30.9400, lon: 34.5600 },
    ...
    Waypoint { name: "judah simeon reach 1.1", lat: 31.4850, lon: 34.7350 },
    Waypoint { name: "the fields of Gerar northward", lat: 31.5200, lon: 34.6200 },
    Waypoint { name: "judah simeon reach 0.1", lat: 31.5350, lon: 34.4700 },
...
const JOS_19_ASHER: &[Waypoint] = &[
    ...
    Waypoint { name: "asher north reach 0.1", lat: 33.3200, lon: 35.2000 },
    ...
    Waypoint { name: "asher west reach 1.1", lat: 32.8600, lon: 34.9000 },
    Waypoint { name: "the sea under Carmel", lat: 32.7200, lon: 34.8500 },
    Waypoint { name: "under Jokneam", lat: 32.6800, lon: 35.0200 },
    Waypoint { name: "the shoulder of Carmel", lat: 32.7000, lon: 34.9500 },
    Waypoint { name: "the sea under Carmel", lat: 32.7200, lon: 34.8500 },
...
const JOS_13_REUBEN: &[Waypoint] = &[
    ...
    Waypoint { name: "reuben west reach 0.1", lat: 31.6050, lon: 35.5100 },
...
const JOS_13_GAD: &[Waypoint] = &[
    ...
    Waypoint { name: "gad east reach 0.1", lat: 32.2250, lon: 36.1400 },
...
const JOS_13_MANASSEH_EAST: &[Waypoint] = &[
    ...
    Waypoint { name: "me northeast reach 0.1", lat: 33.2900, lon: 35.8600 },
...
// Tribal border rings come from open data now — see
// data/wikimedia/tribes12.geojson and load_tribal_rings() in the
// partition bridge. The JOS_* circuits below survive only as the
// legacy SurveySpec waypoints.
